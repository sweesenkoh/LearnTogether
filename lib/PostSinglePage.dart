...
class PostSinglePage extends StatefulWidget {
  PostSinglePage({Key key, this.postId, this.postTitle}) : super(key: key);
  @override
  _PostSinglePageState createState() => _PostSinglePageState();
...
class _PostSinglePageState extends State<PostSinglePage> {
  ...
  int _value = 0;
  List<String> _value_representation = [
    "created_at",
    "upvotes_count",
    "marked_correct"
  ];
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .orderBy(_value_representation[_value], descending: true)
                    .snapshots(),
      ...
      children: [
        Row(
          children: [
            ...
            if (document.data()["marked_correct"])
              Padding(
                padding: EdgeInsets.only(right: 16),
                child: Container(
                  width: 20,
