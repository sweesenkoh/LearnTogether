...
class ForumSinglePage extends StatefulWidget {
  ForumSinglePage({Key key, this.forumId, this.forumTitle}) : super(key: key);
  @override
  _ForumSinglePageState createState() => _ForumSinglePageState();

  String forumId;
  String forumTitle;
}

class _ForumSinglePageState extends State<ForumSinglePage> {
  bool confirm = false;
          ...
          children: <Widget>[
            ...
            if (document.data()["user_id"] ==
                FirebaseAuth.instance.currentUser
                    .email) //only allow user to edit their own post
              Row(
                mainAxisSize: MainAxisSize.max,
