import 'package:LearnTogether/AdminPages/AdminHomePage.dart';
import 'package:LearnTogether/AdminPages/AdminProfilePage.dart';
...
class AdminBottomNavigationBarHost extends StatefulWidget {
  AdminBottomNavigationBarHost({Key key}) : super(key: key);

  @override
  _AdminBottomNavigationBarHostState createState() =>
      _AdminBottomNavigationBarHostState();
}

class _AdminBottomNavigationBarHostState
    extends State<AdminBottomNavigationBarHost> {
