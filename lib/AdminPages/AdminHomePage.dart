import 'package:LearnTogether/AdminPages/AdminForumSinglePage.dart';
              ...
              stream: FirebaseFirestore.instance
                  ...
                  .where("creator_id",
                      isEqualTo: FirebaseAuth.instance.currentUser
                          .email) //we query only forums where the id is inside the forums enrolled by this user
                  .snapshots(),
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
                context,
                CupertinoPageRoute(
                    builder: (context) => AdminForumSinglePage(
                        forumId: document.id,
